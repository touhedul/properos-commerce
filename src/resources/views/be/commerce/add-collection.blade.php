        ...
        <div class="breadcrumb-wrapper col-12" style="padding-bottom: 15px">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item">
                    <a href="/admin/store/collections">Collections List</a>
                </li>
                <li class="breadcrumb-item">
                    <a href="/admin/store/add-collection">Add collection</a>
                </li>
            </ol>
        </div>
    </div>
...
<div id="commerce-module">
    <collections-create :editable_collection="{{(isset($editable_collection)) ? $editable_collection : json_encode('')}}"
                >
    </collections-create>
</div>
@endsection
